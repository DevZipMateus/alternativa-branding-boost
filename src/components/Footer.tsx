    ...
    <footer className="bg-foreground text-background">
      <div className="section-container py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* Links Rápidos */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-background">Links Rápidos</h3>
          ...
          {/* Contato */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-background">Contato</h3>
          ...
          {/* Horário e Redes */}
          <div>
            <h3 className="text-lg font-bold mb-4 text-background">Horário de Funcionamento</h3>
            ...
            <h3 className="text-lg font-bold mb-4 text-background">Redes Sociais</h3>
            <a 
            ...
            >
              ...
              <span className="text-sm">@alternativaembalagens</span>
            </a>
          </div>
        </div>
